...
\usepackage{ifthen} % Used by \shortreply
...
% For the (associate) editor's general comments, before the individual reviewers
\newcommand{\editorsection}{\bigskip \hrule
                  \section*{\large\textbf{Editor}}}
