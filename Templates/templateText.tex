...
\red{\noindent\textbf{\textsc{Important Notes Before We Start}}:
    \begin{itemize}
        \item This file should be your \texttt{main.tex} in the root of the project.
              If you are reading this from inside the \texttt{Templates} folder, move it there first
              (delete the old \texttt{main.tex}, move this file to the root and rename it \texttt{main.tex}).
              Or just ask Claude to ``start a new EnICS manuscript''.
        \item All of the colored guidance text (like this) is controlled by \textbf{one switch}:
              change \texttt{\textbackslash guidetrue} to \texttt{\textbackslash guidefalse} in the preamble
              and all of it disappears from the PDF. You can then delete the \texttt{\textbackslash guide\{...\}} lines
              and the \texttt{guidance} blocks at your leisure, and delete the \texttt{Templates} folder altogether.
