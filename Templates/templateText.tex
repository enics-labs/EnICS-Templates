...
%<*abstractRP>
\color{teal}
    This is a template for BIU Research Proposals. It includes a general outline for a research proposal that could be followed. Please update the docx files for the front page and the hebrew abstract and save them as PDF files to include in the LaTeX output.\\
...
%<*abstractThesis>
\color{teal}
    This is a template for writing a Thesis. It includes a general outline for a thesis that could be followed. Please update the docx files for the English and Hebrew front page and the hebrew abstract (under the \textbf{Templates/AuxiliaryPages} folder) and save them as PDF files (pointed to by the \texttt{\textbackslash includepdf} command) to include in the LaTeX output.\\
    Note that the abstract for a thesis or research proposal is much more extensive than the short abstract for an article. It should be approximately 1 page long and really be an executive summary of the proposal, including some background, presenting the problem, and explaining how you propose to address it.
